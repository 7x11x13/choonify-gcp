  ...
  function getFilterTypeData() {
    return [
      ...
      },
      {
        ...
        label: isFree
          ? t("types.filtertype.colored-background-premium")
          : t("types.filtertype.colored-background"),
        disabled: isFree,
      },
      {
        value: FilterType.BLURRED_BACKGROUND,
        label: isFree
          ? t("types.filtertype.blurred-background-premium")
          : t("types.filtertype.blurred-background"),
        disabled: isFree,
      },
    ];
  }
    ...
    validate: {
      defaults: {
        metadata: {
          ...
          description: (value) =>
            validateDescription(value, settingsMode === "defaults"),
      ...
      <Fieldset
        ...
        legend={
          settingsMode === "regular"
            ? t("upload_form.upload-settings")
            : t("upload_form.default-settings")
        }
      >
        <Grid>
          ...
          <Grid.Col span={{ base: 12, lg: 6 }}>
            ...
            <Checkbox
              ...
              {...form.getInputProps("defaults.metadata.madeForKids", {
                type: "checkbox",
              })}
            />
            <Checkbox
              ...
              {...form.getInputProps("defaults.metadata.notifySubscribers", {
                type: "checkbox",
              })}
            />
          </Grid.Col>
        ...
        <Group justify="flex-end" mt="md">
          {settingsMode === "defaults" && (
            <Button
              onClick={() => {
                form.setValues(getDefaultUserSettings());
              }}
            >
              {t("upload_form.button.reset-defaults")}
            </Button>
          )}
          <Button disabled={!form.isDirty()} onClick={form.reset}>
            {t("button.cancel")}
          </Button>
