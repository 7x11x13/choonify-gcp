  ...
  return (
    <>
      ...
      >
        ...
        <Menu.Dropdown>
          <Menu.Item
            leftSection={<BsFillGearFill size={16} stroke={"1.5"} />}
            onClick={() => navigate("/settings")}
          >
            {t("header.account-settings")}
          </Menu.Item>
          <Menu.Item
            leftSection={<BsBoxArrowRight size={16} stroke={"1.5"} />}
            onClick={signOut}
          >
            {t("header.logout")}
          </Menu.Item>
          ...
          <Menu.Item
            color="red"
            leftSection={<BsTrash size={16} stroke={"1.5"} />}
